...
abstract public class AMF3_Type extends AMF0_Type {
  private static final Map<U8, Class<? extends AMF3_Type>> types =
      new HashMap<U8, Class<? extends AMF3_Type>>();
  private static final Map<Class<? extends AMF3_Type>, U8> classes =
      new HashMap<Class<? extends AMF3_Type>, U8>();
  ...
  public static void writeType(AMF_Context context, DataOutputStream output, AMF3_Type value)
      throws IOException {
