...
public class AMF3_Trait {
  ...
  public String toString() {
    return "AMF_Trait {className: " + this.className + ", names: " + this.names + ", dynamic: "
        + this.dynamic + ", externalizable: " + this.externalizable + "}";
  }
  ...
  @Override
  public int hashCode() {
    return this.className.hashCode() ^ this.names.hashCode() ^ (this.dynamic ? 8 : 0)
        ^ (this.externalizable ? 4 : 0);
  }
}
