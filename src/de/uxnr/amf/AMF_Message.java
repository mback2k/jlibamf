...
public class AMF_Message {
  ...
  public String toString() {
    return "AMF_Message {targetURI: " + this.targetURI + ", responseURI: " + this.responseURI
        + ", messageLength: " + this.messageLength + "} (" + this.body + ")";
  }
  ...
  @Override
  public int hashCode() {
    return this.targetURI.hashCode() ^ this.responseURI.hashCode() ^ this.messageLength.hashCode()
        ^ this.body.hashCode();
  }
}
