...
abstract public class AMF0_Type implements AMF_Type {
  private static final HashMap<U8, Class<? extends AMF0_Type>> types =
      new HashMap<U8, Class<? extends AMF0_Type>>();
  private static final Map<Class<? extends AMF0_Type>, U8> classes =
      new HashMap<Class<? extends AMF0_Type>, U8>();
  ...
  public static void writeType(AMF_Context context, DataOutputStream output, AMF0_Type value)
      throws IOException {
