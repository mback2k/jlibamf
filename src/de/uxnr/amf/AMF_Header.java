...
public class AMF_Header {
  ...
  public String toString() {
    return "AMF_Header {headerName: " + this.headerName + ", mustUnderstand: "
        + this.mustUnderstand + ", headerLength: " + this.headerLength + "} (" + this.body + ")";
  }
  ...
  @Override
  public int hashCode() {
    return this.headerName.hashCode() ^ this.mustUnderstand.hashCode()
        ^ this.headerLength.hashCode() ^ this.body.hashCode();
  }
}
