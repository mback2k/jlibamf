...
public abstract class AbstractMessageBase extends AMF3_Externalizable {
  private static final UTF8[][] names = new UTF8[][] {
      {new UTF8("body"), new UTF8("clientId"), new UTF8("destination"), new UTF8("headers"),
          new UTF8("messageId"), new UTF8("timestamp"), new UTF8("timeToLive"),},
      {new UTF8("clientUuid"), new UTF8("messageUuid"),}};
  ...
  protected void writeFields(AMF_Context context, DataOutputStream output, UTF8[][] names)
      throws IOException {
  ...
  protected void readFields(AMF_Context context, DataInputStream input, UTF8[][] names)
      throws IOException {
  ...
  private void writeFlags(AMF_Context context, DataOutputStream output, List<Integer> flags)
      throws IOException {
