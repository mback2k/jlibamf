...
public class Flex {
  ...
  public static final UTF8 FLEX_REMOTING_MESSAGE = new UTF8(
      "flex.messaging.messages.RemotingMessage");
  public static final UTF8 FLEX_ASYNC_MESSAGE = new UTF8("flex.messaging.messages.AsyncMessage");
  public static final UTF8 FLEX_ACKNOWLEDGE_MESSAGE = new UTF8(
      "flex.messaging.messages.AcknowledgeMessage");
  public static final UTF8 FLEX_COMMAND_MESSAGE =
      new UTF8("flex.messaging.messages.CommandMessage");
