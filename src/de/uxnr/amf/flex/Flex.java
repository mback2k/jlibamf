...
public class Flex {
	...
	private static final Map<Class, UTF8> classes = new HashMap<Class, UTF8>(); 
	
	public static void registerMessage(UTF8 className, Class typeClass) {
		Flex.messages.put(className, typeClass);
		Flex.classes.put(typeClass, className);
	}
	
	public static void writeMessage(AMF_Context context, DataOutputStream output, AMF_Type value) throws IOException {
